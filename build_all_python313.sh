#!/bin/bash
# pyKooCAE ì ì²´ íµí© ë¹ë ì¤í¬ë¦½í¸ - Python 3.13
# ì¬ì©ë²: ./build_all_python313.sh
# â ï¸ ì£¼ì: Python 3.13ì PythonOCCê° ì¤ì¹ëì§ ìììµëë¤.
...
echo "================================================================================"
echo "pyKooCAE íµí© ë¹ë (Python 3.13)"
echo "================================================================================"
echo "â ï¸  ì£¼ì: Python 3.13ìë PythonOCCê° ì¤ì¹ëì§ ìììµëë¤."
echo "â ï¸  KooMeshModifierì KooAutomatedModeller ë¹ëê° ì¤í¨í  ì ììµëë¤."
echo ""
