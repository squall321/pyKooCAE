...
mode("THERMAL_LOAD", "열 하중 — 균일 온도 변화 열응력 또는 IC 발열(ICPower) 2-pass",
     ...
     keys=[
         ...
         K("TempCurve … EndTempCurve", "시간,값 줄들", "[]", "온도 곡선 직접 지정. 값의 뜻은 TempCurveMode 가 정한다"),
         K("TempCurveMode", "factor | absolute", "factor", "factor=0~1 배율(T=Base+ΔT·f) / absolute=℃ 절대온도"),
         K("TFinal", "실수", "RampTimeS", "ENDTIM. 유지(dwell) 구간을 두려면 RampTimeS 보다 크게"),
