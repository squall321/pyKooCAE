...
def Handle_RWHeaderSection_GeneralModule_Create() -> "opencascade::handle< RWHeaderSection_GeneralModule >":
    return _RWHeaderSection.Handle_RWHeaderSection_GeneralModule_Create()

def Handle_RWHeaderSection_GeneralModule_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< RWHeaderSection_GeneralModule >":
    return _RWHeaderSection.Handle_RWHeaderSection_GeneralModule_DownCast(t)

def Handle_RWHeaderSection_GeneralModule_IsNull(t: "opencascade::handle< RWHeaderSection_GeneralModule > const &") -> "bool":
    return _RWHeaderSection.Handle_RWHeaderSection_GeneralModule_IsNull(t)

def Handle_RWHeaderSection_ReadWriteModule_Create() -> "opencascade::handle< RWHeaderSection_ReadWriteModule >":
    return _RWHeaderSection.Handle_RWHeaderSection_ReadWriteModule_Create()

def Handle_RWHeaderSection_ReadWriteModule_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< RWHeaderSection_ReadWriteModule >":
    return _RWHeaderSection.Handle_RWHeaderSection_ReadWriteModule_DownCast(t)

def Handle_RWHeaderSection_ReadWriteModule_IsNull(t: "opencascade::handle< RWHeaderSection_ReadWriteModule > const &") -> "bool":
...
def rwheadersection_Init(*args) -> "void":
    r"""
    Enforced the initialisation of the libraries.
