...
class vector_gp_Pnt(object):
    ...
    def reserve(self, n: "std::vector< gp_Pnt >::size_type") -> "void":
        return _MeshDS.vector_gp_Pnt_reserve(self, n)

    def capacity(self) -> "std::vector< gp_Pnt >::size_type":
...
class vector_vector_int(object):
    ...
    def append(self, x: "vector_int") -> "void":
    ...
    def swap(self, v: "vector_vector_int") -> "void":
    ...
    def push_back(self, x: "vector_int") -> "void":
    ...
    def assign(self, n: "std::vector< std::vector< int > >::size_type", x: "vector_int") -> "void":
...
class vector_vec(object):
    ...
    def reserve(self, n: "std::vector< gp_Vec >::size_type") -> "void":
        return _MeshDS.vector_vec_reserve(self, n)

    def capacity(self) -> "std::vector< gp_Vec >::size_type":
...
class vector_vector_vec(object):
    ...
    def __len__(self) -> "std::vector< std::vector< gp_Vec > >::size_type":
        return _MeshDS.vector_vector_vec___len__(self)

    def __getslice__(self, i: "std::vector< std::vector< gp_Vec > >::difference_type", j: "std::vector< std::vector< gp_Vec > >::difference_type") -> "std::vector< std::vector< gp_Vec,std::allocator< gp_Vec > >,std::allocator< std::vector< gp_Vec,std::allocator< gp_Vec > > > > *":
        return _MeshDS.vector_vector_vec___getslice__(self, i, j)

    def __setslice__(self, *args) -> "void":
        return _MeshDS.vector_vector_vec___setslice__(self, *args)

    def __delslice__(self, i: "std::vector< std::vector< gp_Vec > >::difference_type", j: "std::vector< std::vector< gp_Vec > >::difference_type") -> "void":
        return _MeshDS.vector_vector_vec___delslice__(self, i, j)

    def __delitem__(self, *args) -> "void":
        return _MeshDS.vector_vector_vec___delitem__(self, *args)

    def __getitem__(self, *args) -> "std::vector< std::vector< gp_Vec > >::value_type const &":
        return _MeshDS.vector_vector_vec___getitem__(self, *args)

    def __setitem__(self, *args) -> "void":
        return _MeshDS.vector_vector_vec___setitem__(self, *args)

    def pop(self) -> "std::vector< std::vector< gp_Vec > >::value_type":
        return _MeshDS.vector_vector_vec_pop(self)

    def append(self, x: "vector_vec") -> "void":
        return _MeshDS.vector_vector_vec_append(self, x)

    def empty(self) -> "bool":
        return _MeshDS.vector_vector_vec_empty(self)

    def size(self) -> "std::vector< std::vector< gp_Vec > >::size_type":
        return _MeshDS.vector_vector_vec_size(self)

    def swap(self, v: "vector_vector_vec") -> "void":
        return _MeshDS.vector_vector_vec_swap(self, v)

    def begin(self) -> "std::vector< std::vector< gp_Vec > >::iterator":
        return _MeshDS.vector_vector_vec_begin(self)

    def end(self) -> "std::vector< std::vector< gp_Vec > >::iterator":
        return _MeshDS.vector_vector_vec_end(self)

    def rbegin(self) -> "std::vector< std::vector< gp_Vec > >::reverse_iterator":
        return _MeshDS.vector_vector_vec_rbegin(self)

    def rend(self) -> "std::vector< std::vector< gp_Vec > >::reverse_iterator":
        return _MeshDS.vector_vector_vec_rend(self)

    def clear(self) -> "void":
        return _MeshDS.vector_vector_vec_clear(self)

    def get_allocator(self) -> "std::vector< std::vector< gp_Vec > >::allocator_type":
        return _MeshDS.vector_vector_vec_get_allocator(self)

    def pop_back(self) -> "void":
        return _MeshDS.vector_vector_vec_pop_back(self)

    def erase(self, *args) -> "std::vector< std::vector< gp_Vec > >::iterator":
    ...
    def push_back(self, x: "vector_vec") -> "void":
        return _MeshDS.vector_vector_vec_push_back(self, x)

    def front(self) -> "std::vector< std::vector< gp_Vec > >::value_type const &":
        return _MeshDS.vector_vector_vec_front(self)

    def back(self) -> "std::vector< std::vector< gp_Vec > >::value_type const &":
        return _MeshDS.vector_vector_vec_back(self)

    def assign(self, n: "std::vector< std::vector< gp_Vec > >::size_type", x: "vector_vec") -> "void":
    ...
    def reserve(self, n: "std::vector< std::vector< gp_Vec > >::size_type") -> "void":
        return _MeshDS.vector_vector_vec_reserve(self, n)

    def capacity(self) -> "std::vector< std::vector< gp_Vec > >::size_type":
...
def Handle_MeshDS_DataSource_Create() -> "opencascade::handle< MeshDS_DataSource >":
    return _MeshDS.Handle_MeshDS_DataSource_Create()

def Handle_MeshDS_DataSource_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< MeshDS_DataSource >":
    return _MeshDS.Handle_MeshDS_DataSource_DownCast(t)

def Handle_MeshDS_DataSource_IsNull(t: "opencascade::handle< MeshDS_DataSource > const &") -> "bool":
...
class MeshDS_DataSource(OCC.Core.MeshVS.MeshVS_DataSource):
    ...
    def SetElemNormals(self, ElemNormalsData: "vector_vec") -> "void":
        return _MeshDS.MeshDS_DataSource_SetElemNormals(self, ElemNormalsData)

    def SetNodeNormals(self, NodeNormalsData: "vector_vector_vec") -> "void":
