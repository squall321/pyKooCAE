...
class ApproxInt_KnotTools(object):
    ...
    @staticmethod
    def BuildCurvature(*args) -> "Standard_Real &":
        r"""
    ...
    @staticmethod
    def DefineParType(*args) -> "Approx_ParametrizationType":
        r"""
...
def ApproxInt_KnotTools_BuildCurvature(*args) -> "Standard_Real &":
    r"""
    Builds discrete curvature.
...
def ApproxInt_KnotTools_DefineParType(*args) -> "Approx_ParametrizationType":
    r"""
    Defines preferable parametrization type for thewl .
...
class ApproxInt_SvSurfaces(object):
    ...
    def GetUseSolver(self, *args) -> "Standard_Boolean":
        r"""
    ...
    def SetUseSolver(self, *args) -> "void":
        r"""
        No available documentation.
