...
class Approx_Array1OfAdHSurface(object):
    ...
    def begin(self) -> "NCollection_Array1< opencascade::handle< Adaptor3d_Surface > >::iterator":
        return _Approx.Approx_Array1OfAdHSurface_begin(self)

    def end(self) -> "NCollection_Array1< opencascade::handle< Adaptor3d_Surface > >::iterator":
        return _Approx.Approx_Array1OfAdHSurface_end(self)

    def cbegin(self) -> "NCollection_Array1< opencascade::handle< Adaptor3d_Surface > >::const_iterator":
        return _Approx.Approx_Array1OfAdHSurface_cbegin(self)

    def cend(self) -> "NCollection_Array1< opencascade::handle< Adaptor3d_Surface > >::const_iterator":
    ...
    def Init(self, theValue: "opencascade::handle< Adaptor3d_Surface > const &") -> "void":
    ...
    def Assign(self, theOther: "Approx_Array1OfAdHSurface") -> "NCollection_Array1< opencascade::handle< Adaptor3d_Surface > > &":
        return _Approx.Approx_Array1OfAdHSurface_Assign(self, theOther)

    def Move(self, theOther: "Approx_Array1OfAdHSurface") -> "NCollection_Array1< opencascade::handle< Adaptor3d_Surface > > &":
        return _Approx.Approx_Array1OfAdHSurface_Move(self, theOther)

    def Set(self, *args) -> "NCollection_Array1< opencascade::handle< Adaptor3d_Surface > > &":
        return _Approx.Approx_Array1OfAdHSurface_Set(self, *args)

    def First(self) -> "opencascade::handle< Adaptor3d_Surface > const &":
        return _Approx.Approx_Array1OfAdHSurface_First(self)

    def ChangeFirst(self) -> "opencascade::handle< Adaptor3d_Surface > &":
        return _Approx.Approx_Array1OfAdHSurface_ChangeFirst(self)

    def Last(self) -> "opencascade::handle< Adaptor3d_Surface > const &":
        return _Approx.Approx_Array1OfAdHSurface_Last(self)

    def ChangeLast(self) -> "opencascade::handle< Adaptor3d_Surface > &":
        return _Approx.Approx_Array1OfAdHSurface_ChangeLast(self)

    def Value(self, theIndex: "Standard_Integer const") -> "opencascade::handle< Adaptor3d_Surface > const &":
        return _Approx.Approx_Array1OfAdHSurface_Value(self, theIndex)

    def ChangeValue(self, theIndex: "Standard_Integer const") -> "opencascade::handle< Adaptor3d_Surface > &":
        return _Approx.Approx_Array1OfAdHSurface_ChangeValue(self, theIndex)

    def __call__(self, *args) -> "opencascade::handle< Adaptor3d_Surface > &":
        return _Approx.Approx_Array1OfAdHSurface___call__(self, *args)

    def SetValue(self, theIndex: "Standard_Integer const", theItem: "opencascade::handle< Adaptor3d_Surface > const &") -> "void":
...
class Approx_SameParameter(object):
    ...
    def CurveOnSurface(self, *args) -> "opencascade::handle< Adaptor3d_CurveOnSurface >":
        r"""
