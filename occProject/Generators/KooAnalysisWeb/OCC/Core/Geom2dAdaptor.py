...
def Handle_Geom2dAdaptor_Curve_Create() -> "opencascade::handle< Geom2dAdaptor_Curve >":
    return _Geom2dAdaptor.Handle_Geom2dAdaptor_Curve_Create()

def Handle_Geom2dAdaptor_Curve_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< Geom2dAdaptor_Curve >":
    return _Geom2dAdaptor.Handle_Geom2dAdaptor_Curve_DownCast(t)

def Handle_Geom2dAdaptor_Curve_IsNull(t: "opencascade::handle< Geom2dAdaptor_Curve > const &") -> "bool":
