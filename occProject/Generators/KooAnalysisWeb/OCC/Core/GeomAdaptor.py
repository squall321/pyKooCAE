...
def Handle_GeomAdaptor_Curve_Create() -> "opencascade::handle< GeomAdaptor_Curve >":
    return _GeomAdaptor.Handle_GeomAdaptor_Curve_Create()

def Handle_GeomAdaptor_Curve_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< GeomAdaptor_Curve >":
    return _GeomAdaptor.Handle_GeomAdaptor_Curve_DownCast(t)

def Handle_GeomAdaptor_Curve_IsNull(t: "opencascade::handle< GeomAdaptor_Curve > const &") -> "bool":
    return _GeomAdaptor.Handle_GeomAdaptor_Curve_IsNull(t)

def Handle_GeomAdaptor_Surface_Create() -> "opencascade::handle< GeomAdaptor_Surface >":
    return _GeomAdaptor.Handle_GeomAdaptor_Surface_Create()

def Handle_GeomAdaptor_Surface_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< GeomAdaptor_Surface >":
    return _GeomAdaptor.Handle_GeomAdaptor_Surface_DownCast(t)

def Handle_GeomAdaptor_Surface_IsNull(t: "opencascade::handle< GeomAdaptor_Surface > const &") -> "bool":
    return _GeomAdaptor.Handle_GeomAdaptor_Surface_IsNull(t)

def Handle_GeomAdaptor_SurfaceOfLinearExtrusion_Create() -> "opencascade::handle< GeomAdaptor_SurfaceOfLinearExtrusion >":
    return _GeomAdaptor.Handle_GeomAdaptor_SurfaceOfLinearExtrusion_Create()

def Handle_GeomAdaptor_SurfaceOfLinearExtrusion_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< GeomAdaptor_SurfaceOfLinearExtrusion >":
    return _GeomAdaptor.Handle_GeomAdaptor_SurfaceOfLinearExtrusion_DownCast(t)

def Handle_GeomAdaptor_SurfaceOfLinearExtrusion_IsNull(t: "opencascade::handle< GeomAdaptor_SurfaceOfLinearExtrusion > const &") -> "bool":
    return _GeomAdaptor.Handle_GeomAdaptor_SurfaceOfLinearExtrusion_IsNull(t)

def Handle_GeomAdaptor_SurfaceOfRevolution_Create() -> "opencascade::handle< GeomAdaptor_SurfaceOfRevolution >":
    return _GeomAdaptor.Handle_GeomAdaptor_SurfaceOfRevolution_Create()

def Handle_GeomAdaptor_SurfaceOfRevolution_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< GeomAdaptor_SurfaceOfRevolution >":
    return _GeomAdaptor.Handle_GeomAdaptor_SurfaceOfRevolution_DownCast(t)

def Handle_GeomAdaptor_SurfaceOfRevolution_IsNull(t: "opencascade::handle< GeomAdaptor_SurfaceOfRevolution > const &") -> "bool":
