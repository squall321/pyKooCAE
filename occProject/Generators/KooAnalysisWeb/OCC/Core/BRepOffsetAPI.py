...
def BRepOffsetAPI_SequenceOfSequenceOfReal_delNode(theNode: "NCollection_SeqNode *", theAl: "opencascade::handle< NCollection_BaseAllocator > &") -> "void":
    return _BRepOffsetAPI.BRepOffsetAPI_SequenceOfSequenceOfReal_delNode(theNode, theAl)
...
def BRepOffsetAPI_SequenceOfSequenceOfShape_delNode(theNode: "NCollection_SeqNode *", theAl: "opencascade::handle< NCollection_BaseAllocator > &") -> "void":
    return _BRepOffsetAPI.BRepOffsetAPI_SequenceOfSequenceOfShape_delNode(theNode, theAl)
...
def BRepOffsetAPI_MakeOffset_ConvertFace(*args) -> "TopoDS_Face":
    r"""
    Converts each wire of the face into contour consisting only of arcs and segments. new 3d curves are built too.
