...
def gp_Vec2f_Length() -> "int":
    return _gp.gp_Vec2f_Length()

def gp_Vec2f_DX() -> "NCollection_Vec2< Standard_ShortReal >":
    return _gp.gp_Vec2f_DX()

def gp_Vec2f_DY() -> "NCollection_Vec2< Standard_ShortReal >":
    return _gp.gp_Vec2f_DY()
...
def gp_Vec3f_Length() -> "int":
    return _gp.gp_Vec3f_Length()

def gp_Vec3f_Cross(theVec1: "gp_Vec3f", theVec2: "gp_Vec3f") -> "NCollection_Vec3< Standard_ShortReal >":
    return _gp.gp_Vec3f_Cross(theVec1, theVec2)

def gp_Vec3f_GetLERP(theFrom: "gp_Vec3f", theTo: "gp_Vec3f", theT: "float const") -> "NCollection_Vec3< Standard_ShortReal >":
    return _gp.gp_Vec3f_GetLERP(theFrom, theTo, theT)

def gp_Vec3f_DX() -> "NCollection_Vec3< Standard_ShortReal >":
    return _gp.gp_Vec3f_DX()

def gp_Vec3f_DY() -> "NCollection_Vec3< Standard_ShortReal >":
    return _gp.gp_Vec3f_DY()

def gp_Vec3f_DZ() -> "NCollection_Vec3< Standard_ShortReal >":
    return _gp.gp_Vec3f_DZ()
...
class gp_Mat(object):
    ...
    def GetChangeValue(self, theRow: "Standard_Integer const", theCol: "Standard_Integer const") -> "Standard_Real":
    ...
    def SetChangeValue(self, theRow: "Standard_Integer const", theCol: "Standard_Integer const", value: "Standard_Real") -> "void":
