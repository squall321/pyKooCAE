...
def Handle_Adaptor2d_Curve2d_Create() -> "opencascade::handle< Adaptor2d_Curve2d >":
    return _Adaptor2d.Handle_Adaptor2d_Curve2d_Create()

def Handle_Adaptor2d_Curve2d_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< Adaptor2d_Curve2d >":
    return _Adaptor2d.Handle_Adaptor2d_Curve2d_DownCast(t)

def Handle_Adaptor2d_Curve2d_IsNull(t: "opencascade::handle< Adaptor2d_Curve2d > const &") -> "bool":
    return _Adaptor2d.Handle_Adaptor2d_Curve2d_IsNull(t)

def Handle_Adaptor2d_Line2d_Create() -> "opencascade::handle< Adaptor2d_Line2d >":
    return _Adaptor2d.Handle_Adaptor2d_Line2d_Create()

def Handle_Adaptor2d_Line2d_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< Adaptor2d_Line2d >":
    return _Adaptor2d.Handle_Adaptor2d_Line2d_DownCast(t)

def Handle_Adaptor2d_Line2d_IsNull(t: "opencascade::handle< Adaptor2d_Line2d > const &") -> "bool":
    return _Adaptor2d.Handle_Adaptor2d_Line2d_IsNull(t)

def Handle_Adaptor2d_OffsetCurve_Create() -> "opencascade::handle< Adaptor2d_OffsetCurve >":
    return _Adaptor2d.Handle_Adaptor2d_OffsetCurve_Create()

def Handle_Adaptor2d_OffsetCurve_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< Adaptor2d_OffsetCurve >":
    return _Adaptor2d.Handle_Adaptor2d_OffsetCurve_DownCast(t)

def Handle_Adaptor2d_OffsetCurve_IsNull(t: "opencascade::handle< Adaptor2d_OffsetCurve > const &") -> "bool":
...
class Adaptor2d_Curve2d(OCC.Core.Standard.Standard_Transient):
    ...
    def Trim(self, *args) -> "opencascade::handle< Adaptor2d_Curve2d >":
        r"""
