...
def Handle_BRepAdaptor_CompCurve_Create() -> "opencascade::handle< BRepAdaptor_CompCurve >":
    return _BRepAdaptor.Handle_BRepAdaptor_CompCurve_Create()

def Handle_BRepAdaptor_CompCurve_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< BRepAdaptor_CompCurve >":
    return _BRepAdaptor.Handle_BRepAdaptor_CompCurve_DownCast(t)

def Handle_BRepAdaptor_CompCurve_IsNull(t: "opencascade::handle< BRepAdaptor_CompCurve > const &") -> "bool":
    return _BRepAdaptor.Handle_BRepAdaptor_CompCurve_IsNull(t)

def Handle_BRepAdaptor_Curve_Create() -> "opencascade::handle< BRepAdaptor_Curve >":
    return _BRepAdaptor.Handle_BRepAdaptor_Curve_Create()

def Handle_BRepAdaptor_Curve_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< BRepAdaptor_Curve >":
    return _BRepAdaptor.Handle_BRepAdaptor_Curve_DownCast(t)

def Handle_BRepAdaptor_Curve_IsNull(t: "opencascade::handle< BRepAdaptor_Curve > const &") -> "bool":
    return _BRepAdaptor.Handle_BRepAdaptor_Curve_IsNull(t)

def Handle_BRepAdaptor_Curve2d_Create() -> "opencascade::handle< BRepAdaptor_Curve2d >":
    return _BRepAdaptor.Handle_BRepAdaptor_Curve2d_Create()

def Handle_BRepAdaptor_Curve2d_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< BRepAdaptor_Curve2d >":
    return _BRepAdaptor.Handle_BRepAdaptor_Curve2d_DownCast(t)

def Handle_BRepAdaptor_Curve2d_IsNull(t: "opencascade::handle< BRepAdaptor_Curve2d > const &") -> "bool":
    return _BRepAdaptor.Handle_BRepAdaptor_Curve2d_IsNull(t)

def Handle_BRepAdaptor_Surface_Create() -> "opencascade::handle< BRepAdaptor_Surface >":
    return _BRepAdaptor.Handle_BRepAdaptor_Surface_Create()

def Handle_BRepAdaptor_Surface_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< BRepAdaptor_Surface >":
    return _BRepAdaptor.Handle_BRepAdaptor_Surface_DownCast(t)

def Handle_BRepAdaptor_Surface_IsNull(t: "opencascade::handle< BRepAdaptor_Surface > const &") -> "bool":
