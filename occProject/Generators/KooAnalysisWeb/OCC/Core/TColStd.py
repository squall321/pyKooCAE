...
class TColStd_MapIntegerHasher(object):
    ...
    @staticmethod
    def HashCode(theKey: "int const &", theUpperBound: "Standard_Integer const") -> "Standard_Integer":
        return _TColStd.TColStd_MapIntegerHasher_HashCode(theKey, theUpperBound)

    @staticmethod
    def IsEqual(theKey1: "int const &", theKey2: "int const &") -> "Standard_Boolean":
...
class TColStd_MapRealHasher(object):
    ...
    @staticmethod
    def HashCode(theKey: "double const &", theUpperBound: "Standard_Integer const") -> "Standard_Integer":
        return _TColStd.TColStd_MapRealHasher_HashCode(theKey, theUpperBound)

    @staticmethod
    def IsEqual(theKey1: "double const &", theKey2: "double const &") -> "Standard_Boolean":
...
class TColStd_MapTransientHasher(object):
    ...
    @staticmethod
    def HashCode(theKey: "opencascade::handle< Standard_Transient > const &", theUpperBound: "Standard_Integer const") -> "Standard_Integer":
        return _TColStd.TColStd_MapTransientHasher_HashCode(theKey, theUpperBound)

    @staticmethod
    def IsEqual(theKey1: "opencascade::handle< Standard_Transient > const &", theKey2: "opencascade::handle< Standard_Transient > const &") -> "Standard_Boolean":
