...
class TopoDSToStep_Builder(TopoDSToStep_Root):
    ...
    def TessellatedValue(self, *args) -> "opencascade::handle< StepVisual_TessellatedItem > const &":
        r"""
        No available documentation.
...
class TopoDSToStep_MakeTessellatedItem(TopoDSToStep_Root):
    ...
    def Value(self, *args) -> "opencascade::handle< StepVisual_TessellatedItem > const &":
        r"""
        No available documentation.
