...
def Handle_BinMXCAFDoc_LengthUnitDriver_Create() -> "opencascade::handle< BinMXCAFDoc_LengthUnitDriver >":
    return _BinMXCAFDoc.Handle_BinMXCAFDoc_LengthUnitDriver_Create()

def Handle_BinMXCAFDoc_LengthUnitDriver_DownCast(t: "opencascade::handle< Standard_Transient > const &") -> "opencascade::handle< BinMXCAFDoc_LengthUnitDriver >":
    return _BinMXCAFDoc.Handle_BinMXCAFDoc_LengthUnitDriver_DownCast(t)

def Handle_BinMXCAFDoc_LengthUnitDriver_IsNull(t: "opencascade::handle< BinMXCAFDoc_LengthUnitDriver > const &") -> "bool":
...
class BinMXCAFDoc_LocationDriver(OCC.Core.BinMDF.BinMDF_ADriver):
    ...
    def SetNSDriver(self, *args) -> "void":
        r"""
        No available documentation.
