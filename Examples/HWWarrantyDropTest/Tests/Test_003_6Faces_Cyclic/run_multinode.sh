#!/bin/bash
# Test_003: 6면 3회 연속 낙하 - Cyclic 각도 믹싱 (멀티노드 MPI)
#
# 멀티노드 MPI 모드:
...
#
# 자원 계산 예시 (디폴트):
#   - 동시 DOE 6개 x nodes_per_job 2 = 12노드 필요
...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        -h|--help)
            ...
            echo ""
            echo "  --concurrent-does N  동시 실행 DOE 수 (기본: 6)"
...
echo "=========================================="
echo "Test_003: 6면 3회 연속 낙하 Cyclic (멀티노드)"
echo "=========================================="
